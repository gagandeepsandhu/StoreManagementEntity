<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Purchase.aspx.cs" Inherits="StoreManagementEntity.Purchase" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <asp:Button ID="order" runat="server" Text="Purchase Order"  class="btn btn-danger" OnClick="order_Click" />
                        
                </div>
                <h1 id="data" runat="server"> </h1>
            </div>
            <div class="col-md-6">
                <img src="pic/a5.jpg" class="sideImage"/>
            </div>
